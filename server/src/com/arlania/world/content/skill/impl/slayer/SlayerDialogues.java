...
public class SlayerDialogues {
    ...
    public static Dialogue resetTaskDialogue(final Player player) {
        ...
        return new Dialogue() {
            ...
            public String[] dialogue() {
                return new String[]{
                        "It currently costs 5 Paepoints to reset a task.",
    ...
    public static Dialogue resetTaskDialogueUnnatural(final Player player) {
        final SlayerMaster master = player.getSlayer().getSlayerMaster();
        return new Dialogue() {
            @Override
            public DialogueType type() {
            ...
            public String[] dialogue() {
                return new String[]{
                        "Tasks are cancelled for free with Unnatural.",
                        "You will also keep your Task Streak.",
                        "Are you sure you wish to continue?"
                };
            }
